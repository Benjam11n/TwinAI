      ...
      {items.map((item) => (
        ...
        >
          ...
          <Image
            ...
            src={item.image}
            alt={item.name}
            className="relative !m-0 size-14 rounded-full border-2 border-background object-cover object-top !p-0 transition duration-500 group-hover:z-30 group-hover:scale-105"
          />
        </div>
      ))}
    </div>
